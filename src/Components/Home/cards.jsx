...
const Cards = ({donateCard}) => {
    ...
    return (
        <div>
            ...
            <div style={{background:card_bg_color}} className="card h-96 w-full shadow-xl">
  <figure className="px-2 pt-2">
  <img  src={picture} alt="" />
  </figure>
  <div className="card-actions my-3 mx-4">
      <button style={{background:button_bg_color, color:text_color}} className="btn">{category}</button>
    </div>
